...
public class Application {
	...
	public static ArrayList<Application> getApplications(int departmentId) {
		...
		Connection connection = DBConnection.getConnection();
		String sql = "SELECT * FROM APPLICATION WHERE OPPORTUNITY_ID IN(SELECT OPPORTUNITY_ID FROM JOB_OPPORTUNITY WHERE DEPARTMENT_ID=?) ORDER BY APPLICATION_DATE DESC";
	...
	public static ArrayList<Application> getApplications(int departmentId,
		...
		Connection connection = DBConnection.getConnection();
		String sql = "SELECT * FROM APPLICATION WHERE OPPORTUNITY_ID IN(SELECT OPPORTUNITY_ID FROM JOB_OPPORTUNITY WHERE DEPARTMENT_ID=?) AND STATUS=? ORDER BY APPLICATION_DATE DESC";
	...
	public static ArrayList<Application> getApplications(int interviewer,
		...
		Connection connection = DBConnection.getConnection();
		String sql = "SELECT * FROM APPLICATION WHERE INTERVIEWER=? AND INTERVIEW_DATE=? AND INTERVIEW_TIME=? ORDER BY INTERVIEW_DATE ASC";
	...
	public static ArrayList<Application> getApplicationsByStatus(int status) {
		...
		Connection connection = DBConnection.getConnection();
		String sql = "SELECT * FROM APPLICATION WHERE STATUS=? ORDER BY APPLICATION_DATE DESC";
	...
	public static ArrayList<Date> getInterviewDates(int interviewer) {
		...
		Connection connection = DBConnection.getConnection();
		String sql = "SELECT DISTINCT INTERVIEW_DATE FROM APPLICATION WHERE INTERVIEWER=? ORDER BY INTERVIEW_DATE ASC";
	...
	public static ArrayList<Time> getInterviewTimes(int interviewer,
		...
		Connection connection = DBConnection.getConnection();
		String sql = "SELECT DISTINCT INTERVIEW_TIME FROM APPLICATION WHERE INTERVIEWER=? AND INTERVIEW_DATE=? ORDER BY INTERVIEW_TIME ASC";
	...
	public static int getNumberOfApplications(int interviewer,
		...
		Connection connection = DBConnection.getConnection();
		String sql = "SELECT COUNT(*) FROM APPLICATION WHERE INTERVIEWER=? AND INTERVIEW_DATE=? AND INTERVIEW_TIME=?";
	...
	public boolean storeApplication() {
		...
		String sql = "INSERT INTO APPLICATION VALUES(DEFAULT,?,?,?,?,?,NULL,NULL,NULL,NULL,NULL,NULL)";
		Connection connection = DBConnection.getConnection();
		try {
			PreparedStatement statement = connection.prepareStatement(sql);
	...
	public static boolean exists(String email, String opportunityId) {
		...
		String sql = "SELECT COUNT(*) FROM APPLICATION WHERE EMAIL=? AND OPPORTUNITY_ID=?";
		try {
			PreparedStatement statement = connection.prepareStatement(sql);
			statement.setString(1, email);
			statement.setString(2, opportunityId);
	...
	public static boolean selectForHire(int applicationId) {
		...
		Connection connection = DBConnection.getConnection();
		String sql = "UPDATE APPLICATION SET STATUS=?, OFFER_ID=? WHERE APPLICATION_ID=?";
		...
		try {
			...
			sql = "UPDATE JOB_OPPORTUNITY SET NO_OF_VACANCIES=NO_OF_VACANCIES-1 WHERE OPPORTUNITY_ID=(SELECT OPPORTUNITY_ID FROM APPLICATION WHERE APPLICATION_ID=?)";
	...
	public static boolean rejectApplication(int applicationId, int status, String rejectionReason) {
		...
		Connection connection = DBConnection.getConnection();
		String sql = "UPDATE APPLICATION SET STATUS=?, REASON=? WHERE APPLICATION_ID=?";
	...
	public static boolean scheduleInterview(int applicationId, int interviewer, Date interviewDate, Time interviewTime) {
		...
		Connection connection = DBConnection.getConnection();
		String sql = "UPDATE APPLICATION SET INTERVIEWER=?, INTERVIEW_DATE=?, INTERVIEW_TIME=? WHERE APPLICATION_ID=?";
	...
	public static boolean updateScore(int applicationId, int interviewResult) {
		...
		Connection connection = DBConnection.getConnection();
		String sql = "UPDATE APPLICATION SET RESULT=? WHERE APPLICATION_ID=?";
	...
	public static boolean acceptOrRejectOffer(String offerID, int status) {
		...
		Connection connection = DBConnection.getConnection();
		String sql = "UPDATE APPLICATION SET STATUS=? WHERE OFFER_ID=?";
		...
		try {
			...
			{
				sql = "SELECT DEPARTMENT_ID, POSITION_ID FROM JOB_OPPORTUNITY WHERE OPPORTUNITY_ID=(SELECT OPPORTUNITY_ID FROM APPLICATION WHERE OFFER_ID=?)";
				statement = connection.prepareStatement(sql);
				...
				sql = "SELECT EMAIL FROM APPLICATION WHERE OFFER_ID=?";
				statement = connection.prepareStatement(sql);
				statement.setString(1, offerID);
				...
				sql = "INSERT INTO EMPLOYEE VALUES(DEFAULT,?,?,NULL,CURRENT_DATE,NULL,?,NULL,NULL,NULL,NULL)";
			...
			sql = "UPDATE APPLICATION SET OFFER_ID=NULL WHERE OFFER_ID=?";
			statement = connection.prepareStatement(sql);
			statement.setString(1, offerID);
			statement.executeUpdate();
	...
	private static String generateOfferId()
	{
		...
		int count = 0;
		Connection connection = DBConnection.getConnection();
		String sql = "SELECT COUNT(*) FROM APPLICATION WHERE OFFER_ID=?";
